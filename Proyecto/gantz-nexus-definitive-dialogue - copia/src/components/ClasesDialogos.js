...
class Decision{
    ...
    ComprobarIndice(indice){
        ...
        if(this.opcion==true){
            ...
            ArrayDialogos.splice(Indice1, 0, ...ArrayNuevosDialogos1)//arreglo.splice(Inicio,cantidadElementosEliminar,item1,item2)
            ArrayDialogos.splice(Indice2, 0, ...ArrayNuevosDialogos2)
        }
        if(this.opcion==false){
            console.log("Se agregaron los dialogos de la opcion 1")
            ArrayDialogos.splice(Indice1, 0, ...ArrayNuevosDialogos0)
        }
    }
