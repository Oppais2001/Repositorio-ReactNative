...
DiccionarioExpresiones= {
    /* Kurono */
    KuronoSerio: require('../../assets/Img/Characters/KuronoSerio.png'),
    KuronoFeliz: require('../../assets/Img/Characters/KuronoFeliz.png'),
    KuronoNervioso: require('../../assets/Img/Characters/KuronoNervioso.png'),
    KuronoTriste: require('../../assets/Img/Characters/KuronoTriste.png'),
    KuronoSorprendido: require('../../assets/Img/Characters/KuronoSorprendido.png'),
    /* Kato */
    KatoSerio: require('../../assets/Img/Characters/KatoSerio.png'),
    KatoNervioso: require('../../assets/Img/Characters/KatoNervioso.png'),
    KatoTriste: require('../../assets/Img/Characters/KatoTriste.png'),
    KatoSorprendido: require('../../assets/Img/Characters/KatoSorprendido.png'),
    /* Kishimoto */
    KishimotoSeria: require('../../assets/Img/Characters/KishimotoSeria.png'),
    KishimotoNerviosa: require('../../assets/Img/Characters/KishimotoNerviosa.png'),
    KishimotoTriste: require('../../assets/Img/Characters/KishimotoTriste.png'),
    KishimotoParpadeo1: require('../../assets/Img/Characters/KishimotoParpadeo1.png'),
    /* Nishi */
    NishiSerio: require('../../assets/Img/Characters/NishiSerio.png')
}
DiccionarioRopa= {
    /* Kurono */
    KuronoUniforme: require('../../assets/Img/Characters/KuronoUniforme.png'),
    KuronoUniformeEnojado: require('../../assets/Img/Characters/KuronoUniformeEnojado.png'),
    KuronoCamisa: require('../../assets/Img/Characters/KuronoCamisa.png'),
    KuronoCamisaEnojado: require('../../assets/Img/Characters/KuronoCamisaEnojado.png'),
    KuronoTraje: require('../../assets/Img/Characters/KuronoTraje.png'),
    KuronoTrajeEnojado: require('../../assets/Img/Characters/KuronoTrajeEnojado.png'),
    KuronoPoleron: require('../../assets/Img/Characters/KuronoPoleron.png'),
    /* Kato */
    KatoUniforme: require('../../assets/Img/Characters/KatoUniforme.png'),
    KatoTraje: require('../../assets/Img/Characters/KatoTraje.png'),
    KatoTrajeEnojado: require('../../assets/Img/Characters/KatoTraje1.png'),
    /* Kishimoto */
    Kishimoto: require('../../assets/Img/Characters/Kishimoto.png'),
    KishimotoUniforme: require('../../assets/Img/Characters/KishimotoUniforme.png'),
    KishimotoTraje: require('../../assets/Img/Characters/KishimotoTraje.png'),
    KishimotoColegial: require('../../assets/Img/Characters/KishimotoColegiala.png'),
    /* Nishi */
    NishiTraje: require('../../assets/Img/Characters/NishiTraje.png'),
    /* Hojo */
    HojoUniforme: require('../../assets/Img/Characters/HojoUniforme.png'),
    HojoTraje: require('../../assets/Img/Characters/HojoTraje.png'),
    /* Sadayo */
    Sadayo: require('../../assets/Img/Characters/Sadayo.png'),
    SadayoTraje: require('../../assets/Img/Characters/SadayoTraje.png'),
    /* Cebollense */
    Cebollense: require('../../assets/Img/Characters/Cebollense.png'),
    /* MR Cebollense */
    MrCebollense: require('../../assets/Img/Characters/MisterCebollense.png'),
    /* Tanaka */
    TanakaFeliz: require('../../assets/Img/Characters/TanakaFeliz.png'),
    TanakaFurioso: require('../../assets/Img/Characters/TanakaFurioso.png')    
}
export{Kurono, Kato, Kishimoto, Nishi, Hojo, Sadayo, Cebollin, MrCebollin}